...
class _EditCategoriesState extends State<EditCategories> {
  ...
  Widget build(BuildContext context) {
    ...
    body: Column(
                children: <Widget>[
                  ListTile(
                    title: const Text('Regular Package', style: TextStyle(
                      color: Colors.black))  ,
                  ...
                  ListTile(
                    title: const Text('Fragile',style: TextStyle(
                      color: Colors.black)),
                    leading: Radio<Category>(
                      ...
                      ListTile(
                    title: const Text('Large' , style: TextStyle(
                      color: Colors.black)),
                    leading: Radio<Category>(
                    ...
                    ListTile(
                    title: const Text('Medecine' , style: TextStyle(
                      color: Colors.black)),
                    leading: Radio<Category>(
